...
function registrate() {
    if (movie1.checked && movie2.checked && movie3.checked) {
        alert(nameInput.innerText + "뭘 좀 아시는 군요~");
    }
    else if (movie1.checked && movie2.checked) {
        alert(nameInput.innerText + "저와 2개나 같네요~");
    }
        ...
        alert(nameInput.innerText + "저와 1개 밖에 안 같네요 ㅠ");
    }
    else {
        alert(nameInput.innerText + "상처 받았어요 나가주세요");
    }
}
